...
class Registry:
    ...
    def _research(self, args):
        ...
        return {"query":result.query,"offline":result.offline,"records":[record.as_dict() for record in result.records],"citations":result.citations(),"provenance":result.provenance(),"notebook_path":args.get("notebook_path")}
